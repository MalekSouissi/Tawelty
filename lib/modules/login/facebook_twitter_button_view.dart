...
class FacebookTwitterButtonView extends StatefulWidget {
  ...
  @override
  State<FacebookTwitterButtonView> createState() => _FacebookTwitterButtonViewState();
}
...
class _FacebookTwitterButtonViewState extends State<FacebookTwitterButtonView> {
  ...
  Future<void> _updateLoginInfo() async {
    ...
    if (token != null) {
      ...
      SharedPreferencesKeys().setStringData(key: 'email', text: email.toString());
      SharedPreferencesKeys().setStringData(key: 'pdp', text: imageUrl.toString());
      postData(token.token).then((value) => NavigationServices(context).gotoTabScreen());
