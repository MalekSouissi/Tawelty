...
class RoomeBookView extends StatefulWidget {
  ...
  const RoomeBookView(
      {Key? key, req, required this.restaurantId
     })
      : super(key: key);
  ...
  List<Step> _mySteps() {
    List<Step> _steps = [
      Step(
        title: Text(
          'Choose guest number',
          style: TextStyle(color: Color(0xFF1C3956), fontSize: 20),
        ),
        content: Container(
          padding: EdgeInsets.symmetric(horizontal: 25),
          width: MediaQuery.of(context).size.width * 0.7,
          decoration: BoxDecoration(
            border: Border.all(width: 1, color: Color(0xFF1C3956)),
...
class FilterChipWidget extends StatefulWidget {
  ...
  FilterChipWidget({ Key? key,  this.chipName = '',  required this.chips }) : super(key: key);
